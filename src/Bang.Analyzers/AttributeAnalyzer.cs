...
public sealed class AttributeAnalyzer : DiagnosticAnalyzer
{
    ...
    private static void Analyze(SyntaxNodeAnalysisContext context)
    {
        ...
        var attributeData = context.GetAttributeDataForArgumentList(argumentList);
    ...
    )
    {
        ...
        {
            //TODO: If the declaring type is a MessagerSystem the filter should be for messages instead. I think.
